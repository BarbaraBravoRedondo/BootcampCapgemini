  ...
  describe('Aislada', () => {
    ...
    describe('OK', () => {
      it('add message: error', (done: DoneFn) => {
        ...
        service.add(message)
        expect(service.ThereIsNotifications).toBeTruthy();
        expect(service.List.length).toBe(1);
        expect(service.List[0].Id).toBe(1);
        expect(service.List[0].Message).toBe(message);
        expect(service.List[0].Type).toBe(NotificationType.error);
      ...
      it('add message: warn', (done: DoneFn) => {
        ...
        expect(service.List[0].Id).toBe(1);
        expect(service.List[0].Message).toBe(message);
        expect(service.List[0].Type).toBe(NotificationType.warn);
      ...
      it('remove message', () => {
        ...
        service.remove(0)
        expect(service.List.length).toBe(1);
        expect(service.List[0].Id).toBe(2);
        service.remove(0)
        expect(service.ThereIsNotifications).toBeFalsy();
      });
